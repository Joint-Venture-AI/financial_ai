...
import 'package:financial_ai_mobile/views/screens/add/components/add_expense_speech.dart';
import 'package:financial_ai_mobile/views/screens/add/components/base_helper.dart';
import 'package:financial_ai_mobile/views/screens/add/components/gradiunt_button.dart';
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
                              ...
                              child: Row(
                                children:
                                    addController.images.map((image) {
                                      final index = addController.images
                                          .indexOf(image);
                                      return Padding(
              ...
              GradientButton(
                title: 'Speech Expense',
                onPressed: () => Get.to(() => AddExpenseSpeech()),
              ),
            ],
          ),
        ),
